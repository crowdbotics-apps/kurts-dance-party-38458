...
## Project Structure
    ...
    ├── kurts_dance_party_38458  # Django project configurations
...
1. Clone this repo and `cd kurts_dance_party_38458`
...
2. Clone this repo and `cd kurts_dance_party_38458`
